...
namespace ai {
	...
	public:
		...
		[[nodiscard]] std::vector<double> calculate(const std::vector<double> &inputs,
		                                            const std::vector<double> &corrects) const;
		[[nodiscard]] virtual double      derivative(double input, double correct) const = 0;
		[[nodiscard]] std::vector<double> derivative(const std::vector<double> &inputs,
		                                             const std::vector<double> &corrects) const;
	...
	public:
		...
		[[nodiscard]] const std::string getName() const override { return "DifferenceSquaredCostFunction"; }
	};
	...
	public:
		...
		[[nodiscard]] const std::string getName() const override { return "CrossEntropy"; }
	};
