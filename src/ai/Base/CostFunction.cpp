...
namespace ai {
	std::vector<double>
		CostFunction::calculate(const std::vector<double> &inputs,
	...
	std::vector<double>
		CostFunction::derivative(const std::vector<double> &inputs,
	                             double                     correct) const {
		std::vector<double> outputs;
	...
	double DifferenceSquaredCostFunction::calculate(double input,
	                                                double correct) const {
